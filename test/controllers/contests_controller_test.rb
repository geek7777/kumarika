...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post contests_url, params: { contest: { description: @contest.description, name: @contest.name, user_id: @contest.user_id } }
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { description: @contest.description, name: @contest.name, user_id: @contest.user_id } }
